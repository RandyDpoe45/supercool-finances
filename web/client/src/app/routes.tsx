...
/**
 * Authenticated routes. `/` is the accounts overview; `/accounts/new` opens a new account; selecting
 * an account opens its statement; `/transfers/new` runs the internal-transfer journey; `/payees`
 * enrolls + lists external payees; `/transfers/external` runs the external-outbound journey (to an
 * enrolled, cooled-off payee).
 */
