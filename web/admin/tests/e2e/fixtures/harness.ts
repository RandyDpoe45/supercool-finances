 ...
 * enumerates every spec) but never runs its bodies — no fixtures, no browser launch — which is
 * exactly what we want until the real stack + seed exist. When spec 08 sets `E2E_ENABLED=1`,
 * this resolves to the live `test.describe` and the suites run for real.
 *
